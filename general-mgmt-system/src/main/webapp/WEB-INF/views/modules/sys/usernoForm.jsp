...
<%-- 		<div class="control-group">
			...
			<div class="control-group">
				...
				<div class="controls">
					<label class="lbl"><input id="effectiveDate" name="effectiveDate" type="text" readonly="readonly" maxlength="30" class="input Wdate" value="<fmt:formatDate value="${user.effectiveDate}" type="both"  pattern="yyyy-MM-dd" dateStyle="full"/>" onclick="WdatePicker({dateFmt:'yyyy-MM-dd',isShowClear:false});"/></label>
				</div>
			</div>
			<div class="control-group">
				<label class="control-label">失效时间:</label>
				<div class="controls">
					<label class="lbl"><input id="expiryDate" name="expiryDate"  type="text" readonly="readonly" maxlength="30" class="input Wdate" value="<fmt:formatDate value="${user.expiryDate}" type="both"  pattern="yyyy-MM-dd" dateStyle="full"/>" onclick="WdatePicker({dateFmt:'yyyy-MM-dd',isShowClear:false});"/></label>
				</div>
			</div>
