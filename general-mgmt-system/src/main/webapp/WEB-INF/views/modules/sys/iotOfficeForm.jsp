...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/sys/iotOffice/">部门管理列表</a></li>
		<li class="active"><a href="${ctx}/sys/iotOffice/form?id=${iotOffice.id}">部门管理<shiro:hasPermission name="sys:iotOffice:edit">${not empty iotOffice.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="sys:iotOffice:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="iotOffice" action="${ctx}/sys/iotOffice/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="control-group">
			...
			<div class="controls">
				<sys:treeselect id="area" name="area.id" value="${iotOffice.area.id}" labelName="area.name" labelValue="${iotOffice.area.name}"
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="useable" htmlEscape="false" maxlength="64" class="input-xlarge "/>
			</div>
		</div>
		<div class="control-group">
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="tenantId" htmlEscape="false" maxlength="64" class="input-xlarge "/>
			</div>
		</div>
		<div class="form-actions">
			<shiro:hasPermission name="sys:iotOffice:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
