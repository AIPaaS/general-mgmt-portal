...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/sys/iot/office/">部门管理列表</a></li>
		<li class="active"><a href="${ctx}/sys/iot/office/form?id=${office.id}">部门管理<shiro:hasPermission name="sys:iot:office:edit">${not empty office.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="sys:iot:office:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="office" action="${ctx}/sys/iot/office/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="form-actions">
			<shiro:hasPermission name="sys:iot:office:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
