...
<head>
	...
	<script type="text/javascript">
		...
		var tree, setting = {view:{selectedMulti:false,dblClickExpand:false},check:{enable:"${checked}",nocheckInherit:true},
				async:{enable:(type==2),url:"${ctx}/sys/gnArea/treeData",autoParam:["id=areaId"]},
				data:{simpleData:{enable:true}},expandSpeed: "",	callback:{
		...
		$(document).ready(function(){
			...
			$.get("${ctx}${url}${fn:indexOf(url,'?')==-1?'?':'&'}&init=true&extId=${extId}&isAll=${isAll}&module=${module}&t="
