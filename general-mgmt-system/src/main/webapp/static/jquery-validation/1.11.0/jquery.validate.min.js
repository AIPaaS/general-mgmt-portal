...
jQuery.validator.addMethod("tenantId", function(b, a) {
	return this.optional(a) || /^[a-zA-Z0-9][a-zA-Z0-9_.-]{2,19}$/.test(b)
}, "3-20位字母或数字开头，允许字母数字下划线");
...
jQuery.validator.addMethod("userName", function(b, a) {
	return this.optional(a) || /^[\u4e00-\u9fa5_a-zA-Z0-9_]+$/.test(b)
}, "只能包括中文、英文字母、数字和下划线");

jQuery.validator.addMethod("menuName", function(b, a) {
	return this.optional(a) || /^[\u4e00-\u9fa5_a-zA-Z0-9]+$/.test(b)
}, "菜单名称必须是中文或字母或数字组成");
jQuery.validator.addMethod("remarks", function(b, a) {
	return this.optional(a) || /^[\u4e00-\u9fa5_a-zA-Z0-9\s'\u3002\uff1b\uff0c\uff1a\u201c\u201d\uff08\uff09\u3001\uff1f\u300a\u300b]+$/.test(b)
}, "只允许输入中文,中文标点,英文,数字,空格");
jQuery.validator.addMethod("url", function(b, a) {
	return this.optional(a) || /(http|ftp|https):\/\/[\w\-_]+(\.[\w\-_]+)+([\w\-\.,@?^=%&amp;:/~\+#]*[\w\-\@?^=%&amp;/~\+#])?/.test(b)
}, "请输入合法的url地址");
...
jQuery.validator.addMethod("mobile", function(c, a) {
	var b = c.length;
	return this.optional(a)
			|| (b == 11 && /^(((13[0-9]{1})|(15[0-9]{1})|(18[0-9]{1}))+\d{8})$/.test(c))
}, "请正确填写您的手机号码");
