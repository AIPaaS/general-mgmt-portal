 ...
 */
package com.ai.platform.common.supcan;
...
import com.ai.platform.common.supcan.annotation.treelist.SupTreeList;
import com.ai.platform.common.supcan.annotation.treelist.cols.SupCol;
import com.ai.platform.common.supcan.annotation.treelist.cols.SupGroup;
import com.ai.platform.common.supcan.treelist.TreeList;
import com.ai.platform.common.supcan.treelist.cols.Col;
import com.ai.platform.common.supcan.treelist.cols.Group;
...
public class SupcanController extends BaseController {
	...
	public TreeList treeList(@PathVariable("typeAlias") String typeAlias) {
		...
		boolean useCache = Global.getConfig("supcan.useCache").equals("true");
		if (useCache){
